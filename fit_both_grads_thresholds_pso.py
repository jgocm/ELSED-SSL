...
def calculate_map(thresholds):
    boundary_grad_th, boundary_angle_threshold_deg, boundary_min_seg_len, markings_grad_th, markings_angle_threshold_deg, markings_min_seg_len = thresholds
...
lb = [5000, 10, 50, 5000, 10, 50]  # Lower bounds
ub = [15000, 90, 300, 15000, 90, 300]  # Upper bounds

thresholds_path = 'annotations/optimal_thresholds.npy'

# Run PSO to optimize the thresholds
optimal_thresholds, optimal_mAP = pso(calculate_map, lb, ub, swarmsize=30, maxiter=2)
